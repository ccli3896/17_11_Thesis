...
function [ALLTS,meansC,stC,stMeans,stMeds] = scoreIFs
...
% stMeds is the median standard deviation; like stMeans.
    ...
    for injE_ind = 1:21
        for injI_ind = 1:21
            ...
            ALLTS{injE_ind,injI_ind} = runIF('tempScore.mat',injE,injI);
            [meansC{injE_ind,injI_ind},stC{injE_ind,injI_ind}]=procNets('tempScore.mat');
